<template>
  <div class="about container">
    ...
    <ul class="list-group">
      ...
      <li class="list-group-item"><span class="glyphicon glyphicon-plus">{{ customer.profession }}</span></li>
...
<script>
    export default {
      ...
      methods: {
        ...
        deleteCustomer(id){
          this.$http.delete("http://localhost:3000/users/"+id).then(function (data) {
